...
public class FinancialServiceProxy implements FinancialService {
    ...
    public FinancialServiceProxy(UserRole userRole, AccountServiceV3 accountService, CreditInfoService creditInfoService){

        this.userRole = userRole;
        this.financialServiceV3 = new FinancialServiceV3Impl(accountService, creditInfoService);
